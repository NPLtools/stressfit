...
- `Example 1 <http://nbviewer.jupyter.org/url/neutron.ujf.cas.cz/restrax/download/stressfit/stressfit_example1.ipynb>`_: ECNS2019, Fitting of strain gradient under the inner surface of a tube, test on synthetic data for STRESS-SPEC.

For more information and use examples, see:

- `MECASENS 2017 poster <http://neutron.ujf.cas.cz/restrax/download/stressfit/saroun_MECASENS_2017.pdf>`_

- `ECRS10, 2018, slides <http://neutron.ujf.cas.cz/restrax/download/stressfit/ECRS2018_stressfit.pdf>`_

- `ECNS 2019, poster <http://neutron.ujf.cas.cz/restrax/download/stressfit/saroun_ECNS2019_poster.pdf>`_


For access to the latest source code, see the `GitHub repository <https://github.com/NPLtools/stressfit>`_.
