...
# Define environment
# input data folder
TABLE_PATH = pkg_resources.resource_filename('stressfit', 'resources/tables/')
inpath = pkg_resources.resource_filename('stressfit', 'resources/data/')
# output data folder
outpath = './'
...
exttab = np.loadtxt(TABLE_PATH+'Fe_mu.dat')
